...
public class DistanceBetweenLettersAlgorithm implements INoiseSeekerExperiment
{
    ...
    public void run() {
        ...
        Integer[][] a = NoiseBuffer.BitBufferFromString(8, "01111110" + "01000010" + "01000010" + "01111110" + "01000010" + "01000010" + "01000010" + "01000010");
        Integer[][] c = NoiseBuffer.BitBufferFromString(8, "01111110" + "01000000" + "01000000" + "01000000" + "01000000" + "01000000" + "01000000" + "01111110");
        Integer[][] e = NoiseBuffer.BitBufferFromString(8, "01111110" + "01000000" + "01000000" + "01111100" + "01000000" + "01000000" + "01000000" + "01111110");
        Integer[][] s = NoiseBuffer.BitBufferFromString(8, "01111110" + "01000000" + "01000000" + "01111110" + "00000010" + "00000010" + "00000010" + "01111110");
        Integer[][] o = NoiseBuffer.BitBufferFromString(8,
                        "11111111" +
                        "10000001" +
                        "10000001" +
                        "10000001" +
        ...
        Integer[][] r1 = NoiseBuffer.BitBufferFromString(8,
"10000111" +
"11111111" +
"11111111" +
"11111111" +
